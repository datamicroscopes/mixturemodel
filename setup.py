...
CYTHON_MODULES = ['microscopes.mixture.definition',
                  'microscopes.mixture.model',
                  'microscopes.mixture._model',
                  ]

LIBRARY_DEPENDENCIES = ["microscopes_common", "microscopes_mixturemodel",
...
basedir = join_path(os.path.dirname(__file__), 'microscopes', 'mixture')
...
setup(version=version,
      ...
      url='https://github.com/datamicroscopes/mixturemodel',
...
# basedir = join(dirname(__file__), 'microscopes', 'mixture')
